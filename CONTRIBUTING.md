...
Scheduler grants are operator-generated; the DDB/SQS/S3 stores are declared in spec.datastores and provisioned by `landing-zone`'s `tenant-substrate`); cluster addons
